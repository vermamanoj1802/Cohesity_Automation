...
- **README_retention.md** – Documentation for this subdirectory and its automation purpose.
- **Playbooks & Scripts** – Ansible playbooks and supporting files for managing retention policies of Cohesity local backup copies.
